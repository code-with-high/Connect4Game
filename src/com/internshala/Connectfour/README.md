# CONNECT4 GAME
###JAVAFX TECHNOLOGY
I have created **ConnectFour Game using JAVA ( javaFX )**

**IDE - intelliJ Idea**
You can access the .JAR file in the repo To run the APP , You must have JDK V8 installed
in your System. Thanks :Smile:
```bash
...
![Connect4](https://github.com/[code-with-high]/[Connect4Game]/blob/[master]/ConnectFour.jpg?raw=true)